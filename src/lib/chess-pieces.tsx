...
export const WhiteKing: React.FC<PieceProps> = ({ className = "w-full h-full" }) => (
  <svg className={className} viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g fill="#fff" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M22.5 25s4.5-7.5 3-10.5c0 0-1-2.5-3-2.5s-3 2.5-3 2.5c-1.5 3 3 10.5 3 10.5" fill="#fff" stroke="#000" strokeLinecap="butt" strokeLinejoin="miter"/>
...
export const getPieceCode = (piece: { type: string; color: string }): string => {
  const colorCode = piece.color === 'w' ? 'w' : 'b';
  const typeCode = piece.type.toUpperCase();
